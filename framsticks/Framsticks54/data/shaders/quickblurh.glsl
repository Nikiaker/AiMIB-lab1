...
v_texcoord4=v_texcoord+vec2(-u_offset,0.0);
v_texcoord3=v_texcoord+vec2(-u_offset*0.33,0.0);
v_texcoord2=v_texcoord+vec2(u_offset*0.33,0.0);
v_texcoord=v_texcoord+vec2(u_offset,0.0);
}
