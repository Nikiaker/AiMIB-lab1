...
class DensityDistribution:
    ...
    def getSignatures(self,array,edges3,steps3):
        ...
        Returns (frequency):
           signature np.array(,dtype=np.float64): returns signature np.array of coefficients
        Returns (distribution):
           signature [np.array(,dtype=np.float64),np.array(,dtype=np.float64)]: returns signature [np.array of points, np.array of weights]
        """
